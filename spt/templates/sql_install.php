...
$sql = "INSERT INTO templates (name, description) VALUES ('[QST02 v0.70] Schweb security update','An email from a company that offers financial and brokerage services with a high degree of fame requesting the target to update their security information.  [Email template only, no web site]')";
mysql_query($sql) or die(mysql_error());
